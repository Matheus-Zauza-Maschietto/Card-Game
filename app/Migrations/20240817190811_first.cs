        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorAbbreviation = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LaguageName = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CardPrintings", x => new { x.CardId, x.PrintingId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CardPrintings_Printings_PrintingId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CardSubTypes", x => new { x.CardId, x.TypeId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CardSubTypes_SubTypes_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CardPrintings_PrintingId",
                table: "CardPrintings",
                column: "PrintingId");

            migrationBuilder.CreateIndex(
                name: "IX_CardSubTypes_TypeId",
                table: "CardSubTypes",
                column: "TypeId");
